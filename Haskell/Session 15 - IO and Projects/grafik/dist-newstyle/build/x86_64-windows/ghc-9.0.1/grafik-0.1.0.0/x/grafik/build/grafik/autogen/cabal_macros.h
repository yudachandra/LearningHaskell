...
/* package grafik-0.1.0.0 */
#ifndef VERSION_grafik
#define VERSION_grafik "0.1.0.0"
#endif /* VERSION_grafik */
#ifndef MIN_VERSION_grafik
#define MIN_VERSION_grafik(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_grafik */
...
#define CURRENT_COMPONENT_ID "grafik-0.1.0.0-inplace-grafik"
